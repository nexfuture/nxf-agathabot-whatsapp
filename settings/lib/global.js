...
*⏰ Duração:* ${data.resultado[0].timestamp} || *Segundos* ${data.resultado[0].seconds} \n
*👉🏻sua música ja esta sendo enviada🔊*`
}
...
return `${teks.titulo} (Baixado por agatha-MD)`
}
...
return `${tempo}, Olá, parece que esse comando não existe, use ${prefix}Menu para visualizar meus comandos...`
}
...
exports.speedagatha = (tempo, sender, r, kyun, uptime, infoSystem) => {
...
return `Calma ai esta com pressa? agora espere *5* segundos...`
}

exports.timeRequired = () => {
return `Eu so baixo musica e não podcast, não baixo acima de *20 minutos*.`
}

exports.error = () => {
return `Hummm parece que teve um pequeno erro, por favor, tente novamente...`
}
