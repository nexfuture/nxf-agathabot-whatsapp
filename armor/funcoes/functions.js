...
const banner2 = cfonts.render((`CONECTADA...`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`AGATHA|3.0`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const chyt = "551140028922@s.whatsapp.net";
const nit = "551140028922@s.whatsapp.net";
const supre = "551140028922@s.whatsapp.net";
